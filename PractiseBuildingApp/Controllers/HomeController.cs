...
using PractiseBuildingApp.Models;
using PractiseBuildingApp.Services;

namespace PractiseBuildingApp.Controllers
{
    public class HomeController : Controller
    {
        ...
        public ActionResult Contact(ContactModel model)
        {
            ...
            if (_mail.SendMail(model.Email, "kiril_zafirov@yahoo.com", "SomeRandom Thesis", msg))
            {
        ...
        [Authorize(Users = "kiril_zafirov@yahoo.com")]
